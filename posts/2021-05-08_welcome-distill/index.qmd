...
<a href="https://www.jhelvy.com" class="icon-link" target="_blank" rel="noopener"><i class="fa-solid fa-globe"></i> site</a>
<a href="https://github.com/jhelvy/jhelvy.com" class="icon-link" target="_blank" rel="noopener"><i class="fa-brands fa-github"></i> source</a>


I particularly like his `icon_link` buttons (as demonstrated just above)^[Since I've updated my site to Quarto, the `icon_link` function is very temperamental - it needs rewriting. When porting this post from my {distill} to Quarto site, I've used raw HTML rather than `icon_link` to recreate these.], and the second collection for talks. John tells me he is turn took inspiration for this from [Emi Tanaka's site](https://emitanaka.org/).

- Ijeamaka Anyene

<a href="https://ijeamaka-anyene.netlify.app/" class="icon-link" target="_blank" rel="noopener"><i class="fa-solid fa-globe"></i> site</a>
<a href="https://github.com/Ijeamakaanyene/ijeamaka-anyene" class="icon-link" target="_blank" rel="noopener"><i class="fa-brands fa-github"></i> source</a>

Ijeamaka has a really cool projects page, where she's created a card for each project, which I've implemented on my site.

- Tom Mock

<a href="https://themockup.blog" class="icon-link" target="_blank" rel="noopener"><i class="fa-solid fa-globe"></i> site</a>
<a href="https://github.com/jthomasmock/radix_themockup" class="icon-link" target="_blank" rel="noopener"><i class="fa-brands fa-github"></i> source</a>
...
<a href="https://github.com/EllaKaye/distilltools" class="icon-link" target="_blank" rel="noopener"><i class="fa-brands fa-github"></i> source</a>
