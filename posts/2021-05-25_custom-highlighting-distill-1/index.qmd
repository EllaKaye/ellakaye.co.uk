...
```{r fig-ek-syntax-highlighting-palette, echo = FALSE, eval = TRUE, fig.cap="The color palette used for syntax highlighting throughout this site.", fig.alt="A swatch of five colours, a bright pink, orange, green, blue and purple."}
