...
As on my {distill} site, I've made copious use of the `icon_link()` function in [{distilltools}](https://github.com/EllaKaye/distilltools/){target="_blank"}, a handy R function that creates a link, with an icon and some text that, with some additional CSS, is styled a bit like a button, e.g. 
