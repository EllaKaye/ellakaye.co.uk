...
The more I worked on the site, the more I wanted to tweak. In doing so, I learnt a lot, and I've managed, with help, to implement customisations that I haven't seen or read about elsewhere in relation to Quarto. Getting a basic Quarto site up is relatively straight-forward (in fact, Tom Mock shows how it can be done in just [100 seconds](https://www.youtube.com/watch?v=t8qtcDyCRFA){target="_blank"}), but extensive customisation, particularly when starting with a rudimentary knowledge of HTML and CSS, turned out to be pretty tricky. 
